...
for epoch in range(num_epochs):
    ...
    for i, data_train in enumerate(train_data):
        ...
        # print(f'Predicted Labels before softmax: {pred_train}')
        # print(f'Predicted Labels after softmax: {torch.softmax(pred_train, dim=1)}')
        ...
        # print(f'Running Loss train: {running_loss_train}')
        ...
        if i % data_record_interval == 0:
            ...
            # print(f'Train Labels: {label_train}')
            # print(f'Predicted Labels: {torch.softmax(pred_train, dim=0).argmax(dim=0)}')
    ...
    # Calling the scheduler to modify the learning rate:
    scheduler.step()
